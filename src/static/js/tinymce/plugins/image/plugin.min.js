tinymce.PluginManager.add("image", function(e) {
    function openmanager(current_window) {

        var ifframe = $("<iframe></iframe>");
        var input = $('<input type="file" id="file" name="file" size="10"/>');
        var form = $('<form action="/admin/upload" method="post" enctype="multipart/form-data"></form> ');
        form.append(input);
        ifframe.append(form);
        ...
        form.submit(function(event){
          ...
          $("#"+$(current_window.currentTarget.innerHTML).find("label:contains('Source')").parent().parent().parent()[0].id).append('<div id="waite-for-upload">Uploading image... Please waite <span class="glyphicon glyphicon-refresh glyphicon-refresh-animate"></span></div>');
          ...
          $.ajax({
            ...
            success: function (returndata) {
                $("#"+$(current_window.currentTarget.innerHTML).find("label:contains('Source')").parent().parent().parent()[0].id).find("#waite-for-upload").html("Upload Done!");
                $("#"+$(current_window.currentTarget.innerHTML).find("label:contains('Source')").parent().find("input")[0].id).val(window.location.origin+"/images/"+returndata.id);
            }
          });
